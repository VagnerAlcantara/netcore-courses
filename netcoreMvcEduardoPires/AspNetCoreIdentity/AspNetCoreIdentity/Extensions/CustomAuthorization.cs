...
namespace AspNetCoreIdentity.Extensions
{
    ...
    {
        public ClaimsAutorizeAttribute(string claimName, string claimValue) : base(typeof(RequisitoClaimFilter))
        {
    ...
    public class RequisitoClaimFilter : IAuthorizationFilter
    {
        ...
        {
            //Retorna para uma rota customizada caso o usuário não esteja autitenticado
